#ifndef Lampa_4_led_h
#define Lampa_4_led_h

#include "Arduino.h"
#include "Defines.h"

class Lampa_4_led { // osztály a 4 lámpás jelzőnek
public:
    ...
    Lampa_4_led(int id, int zold=22, int sarga_1=24, int piros=26, int sarga_2=28) { // konstruktor a Lampa_4_led osztalyhoz, a kimenetek pinjeit itt rendeli hozzá
        zold_pin=zold;
        sarga_1_pin=sarga_1;
        piros_pin=piros;
        sarga_2_pin=sarga_2;
    ...
    void init(void){
        ...
        pinMode(sarga_1_pin,OUTPUT);
        pinMode(piros_pin,OUTPUT);
        pinMode(sarga_2_pin,OUTPUT);
        
        digitalWrite(zold_pin,HIGH);
        digitalWrite(sarga_1_pin,HIGH);
        digitalWrite(piros_pin,HIGH);
        digitalWrite(sarga_2_pin,HIGH);
    }
